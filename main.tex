...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/4_deterministic.pdf}
    \includegraphics[width=0.7\textwidth]{img/4_kl-olop.pdf}
    \includegraphics[width=0.7\textwidth]{img/4_state_aware.pdf}
    \caption{Trees expanded for $n = 5460$, $\gamma=0.95$}
    \label{fig:gw4_trees}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/4_occupations_deterministic.pdf}
    \includegraphics[width=0.7\textwidth]{img/4_occupations_kl-olop.pdf}
    \includegraphics[width=0.7\textwidth]{img/4_occupations_state_aware.pdf}
