...
\newcommand{\hlrb}[1]{\bm{\textcolor{fireenginered}{#1}}}
\newcommand{\hlbb}[1]{\bm{\textcolor{azure(colorwheel)}{#1}}}
\newcommand{\hlgb}[1]{\bm{\textcolor{forestgreen(web)}{#1}}}
\newcommand{\hlob}[1]{\bm{\textcolor{orange}{#1}}}


\newcommand{\OPD}{{\hyperref[alg:opd]{\texttt{OPD}}}\xspace}
